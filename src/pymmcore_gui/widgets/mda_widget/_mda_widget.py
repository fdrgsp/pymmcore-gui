...
class _MDAWidget(MDAWidget):
    ...
    def value(self) -> MDASequence:
        ...
        segment_and_analyse = None  # self._seg_and_analysis_wdg.value()
    ...
    def setValue(self, value: MDASequence) -> None:
        ...
        meta: dict = value.metadata.get(PYMMCW_METADATA_KEY, {})
    ...
    def prepare_mda(self) -> Any:
        ...
        if self.save_info.isChecked():
            ...
            if isinstance(save_path, Path):
                ...
                return self._create_writer(save_format, save_path)
        return None
    ...
    def _set_arduino_props(self, arduino: Arduino | None, led: Pin | None) -> None:
        ...
        if not isinstance(self._mmc.mda.engine, ArduinoEngine):
            return
