...
from pymmcore_gui.calcium_plate_viewer._util import STIMULATION_MASK

if TYPE_CHECKING:
    from matplotlib.axes import Axes

    from pymmcore_gui.calcium_plate_viewer._graph_widgets import (
        _SingleWellGraphWidget,
    )
    from pymmcore_gui.calcium_plate_viewer._util import ROIData
